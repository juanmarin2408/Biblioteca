...
class LibrosAppHermosa:
    def __init__(self, root):
        ...
        self.style.set_theme("arc")  # Tema moderno y elegante
...
def main():
    ...
    if not conn:
        messagebox.showerror("❌ Error de Conexión", 
                           ...
                           "Verifique que MySQL esté ejecutándose y que las credenciales sean correctas.")
        return
    conn.close()
    
    # Crear y ejecutar la aplicación
    root = ThemedTk(theme="arc")
    app = LibrosAppHermosa(root)
    root.mainloop()
